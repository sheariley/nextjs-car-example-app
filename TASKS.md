# Tasks
- [x] Get basic data-grid working and pulling from mock JSON data
- [ ] Add filtering to data-grid
- [ ] Add car detail page with features
- [ ] Add navigation from data-grid to car detail page
